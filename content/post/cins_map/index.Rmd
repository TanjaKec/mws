...
Belgrade city has several municipalities, but donations to local political parties for the period between 2012-2018 is given for the whole of Belgrade. This requires pulling out the boundary for the whole of the Belgrade district and combining it with the boundaries for the rest of the Serbian municipalities.
